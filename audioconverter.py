...
parser.add_argument("-v","--vorbis-options",dest="oggencopts",
...
parser.add_argument("-l","--lame-options",dest="lameopts",
...
parser.add_argument("-a","--aacplus-options",dest="aacplusopts",
...
parser.add_argument("-n","--nodirs",dest="nodirs",action="store_true",
